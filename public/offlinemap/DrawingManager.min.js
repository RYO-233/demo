...
(function() {
	...
	DrawingManager.prototype.closeInstanceExcept = function () {
	    // 判断绘制状态是否已经开启
	    if (this._isOpen == true) {
	        return true;
	    }
    ...
    DrawingManager.prototype._bindCircle = function () {
        ...
        //更换资源
        var centerIcon = new BMap.Icon('./assets/community/circenter.png', new BMap.Size(20, 20));
        var moveIcon = new BMap.Icon('./assets/community/nbsearch2.png', new BMap.Size(40, 20), {
    ...
    DrawingManager.prototype._bindRectangle = function () {
        ...
        var moveIcon = new BMap.Icon('./assets/community/bullet2.png', new BMap.Size(10, 10));
        ...
        var startAction = function (e) {
            ...
            mask.enableEdgeMove();
            mask.addEventListener('mousemove', moveAction);
			// baidu.on(document, 'mousedown', onMouseDown);
            baidu.on(document, 'mouseup', endAction);
        };
        /**
         * 绘制矩形过程中，鼠标移动过程的事件
  ...
  //       var ll = map.mercatorToLnglat(point.lng, point.lat);
		...
		var mctXY = new BMap.Pixel(point.lng, point.lat);    
